...
const Hero: React.FC = () => {
  return (
    <section id="hero" className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 relative z-10 flex flex-col md:flex-row items-center">
        <motion.div
        ...
        >
          <span className="text-primary font-bold tracking-widest uppercase text-xs mb-4 block">
            Senior Full Stack Developer & eCommerce Expert
          </span>
          ...
          <p className="text-muted text-base sm:text-lg md:text-xl mb-10 max-w-lg leading-relaxed">
          ...
          <div className="mt-8 sm:mt-12 flex items-center space-x-6 justify-start">
            <a href="https://github.com/saad163" className="text-muted hover:text-primary transition-all transform hover:scale-110"><Github size={22} /></a>
            <a href="https://www.linkedin.com/in/muhammad-saad-hasan-7228b2377/" className="text-muted hover:text-primary transition-all transform hover:scale-110"><Linkedin size={22} /></a>
            <div
              onClick={openEmail}
        ...
        <motion.div
          ...
          className="md:w-1/2 mt-12 sm:mt-16 md:mt-0 flex justify-center relative"
        >
          <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-[450px] lg:h-[450px]">
            ...
            {/* Experience Badge */}
            <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 bg-white p-4 sm:p-6 rounded-2xl shadow-hover border border-slate-50 z-20 hidden xs:block">
